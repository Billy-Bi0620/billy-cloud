...
import com.billy.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    {
        List<SysDept> deptList = deptMapper.selectDeptList(deptVo);
    ...
    public List<Ztree> roleDeptTreeData(SysRole role)
    {
        ...
        List<SysDept> deptList = selectDeptList(new SysDeptFilterVO());
