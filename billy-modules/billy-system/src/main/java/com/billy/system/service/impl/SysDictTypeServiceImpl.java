...
import com.billy.system.mapper.SysDictDataMapper;
import com.billy.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
     ...
     */
    @Override
    public List<SysDictType> selectDictTypeList(SysDictTypeFilterVO dictType)
    {
    ...
    public int deleteDictTypeByIds(String ids) throws BusinessException
    {
        ...
        for (Long dictId : dictIds)
        {
            ...
            if (dictType == null) {
                throw new CustomException("当前字典类型不存在");
            }
