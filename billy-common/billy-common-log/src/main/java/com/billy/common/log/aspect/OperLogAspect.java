package com.billy.common.log.aspect;
...
import com.billy.common.log.enums.BusinessStatus;
import com.billy.common.log.event.SysOperLogEvent;
...
{
    // 配置织入点
    @Pointcut("@annotation(com.billy.common.log.annotation.OperLog)")
