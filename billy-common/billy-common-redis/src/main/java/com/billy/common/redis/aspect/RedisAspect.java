package com.billy.common.redis.aspect;


import com.billy.common.redis.annotation.RedisCache;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.billy.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {

    }

    @Pointcut("@annotation(com.billy.common.redis.annotation.RedisEvict)")
